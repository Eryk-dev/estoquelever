...
const EVENTO_LABELS: Record<string, string> = {
  ...
  embalagem_fisica_registrada: "Embalagem física registrada",
  conferencia_ok: "Conferência OK",
  conferencia_divergencia: "Divergência na conferência",
...
const EVENTO_TONE: Record<string, EventoTone> = {
  ...
  embalado: "ok",
  conferencia_ok: "ok",
  conferencia_divergencia: "danger",
  embalagem_fisica_registrada: "info",
  reservado: "info",
