-- Fix: SKU matching was case-sensitive, causing 404 when operators type
-- lowercase SKUs (e.g., "ld023357") but DB stores uppercase ("LD023357").
-- Use UPPER() for case-insensitive comparison on both sku and gtin.
