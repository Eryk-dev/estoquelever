        ...
        <div className="mx-auto flex max-w-7xl items-center gap-3 px-4 py-3">
          ...
          <div className="min-w-0 flex-1">
            ...
            <p className="truncate text-[11px] text-ink-faint sm:text-xs">
              Operação do galpão e controle gerencial no mesmo painel
            </p>
          </div>
      ...
      <main className="mx-auto max-w-7xl space-y-5 px-4 py-5">
        ...
        <div className="grid gap-5 xl:grid-cols-2">
          <BoardShell
            ...
            subtitle="Leitura do chão de operação com foco em urgência, fluxo e execução"
            icon={Monitor}
            tone="ops"
          >
                  ...
                  items={[
                    {
                      ...
                      share: data.operations.deadlines.risk_share_pct,
                      tone: "red",
                    },
                    {
                      label: "Vence em 2h",
                    ...
                    },
                    {
                      ...
                      share: data.operations.deadlines.without_deadline_share_pct,
                      tone: "slate",
                    },
                  ]}
          ...
          <BoardShell
            title="Quadro Gerencial"
            subtitle="Leitura executiva de produtividade, concentração e disciplina operacional"
            icon={TrendingUp}
            tone="mgmt"
          >
            <section className="grid gap-3 sm:grid-cols-2 2xl:grid-cols-4">
                  ...
                  <div className="mt-4 border-t border-line pt-3">
                    ...
                    <div className="space-y-2">
                      {data.alerts.error_samples.map((sample, index) => (
                        <div key={`${sample.source}-${index}`} className="rounded-xl border border-line bg-surface px-3 py-2.5">
...
function DeadlineList({
  ...
  items: { label: string; count: number; share: number; tone: string }[];
  total: number;
}) {
